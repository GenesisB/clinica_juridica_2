	...
	<h2 class="titulo_fieldset">Búsqueda Unificada de Causas </h2>
	...
	<div><br>
		...
		<br><br>
		<a style="margin-left: 30px; margin-right:5px;">Buscar Solo Causas Vigentes</a>
		<input type="checkbox" name="vigentes" id="vigentes" value="si">
		...
		<button onClick="buscar_causas();" class="boton" style="margin-right:15px;float:right;">Buscar</button>
